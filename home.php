...
<body>
    ...
    <div class="bg_image">
        <img src="images/buildings_background.jfif">
        <div class="bg_image_text">
            DISCOVER YOUR EMPIRE.
        </div>
    </div>

    <!-- Quick info about company -->
    ...
    <div class="preview_properties">
        ...
        <!-- <div class="property" onclick="location.href='#home'">
            ...
            <div class="property_text">
                ...
                <p class="location">Hudson Yards</p>
                <p class="price">$2,750,000</p>
                <p class="details">2 Bed • 2 Bath • 1600 sqft</p>
            </div>
        </div>

        <div class="property" onclick="location.href='#home'">
            <img src="images/properties/park_avenue.png" class="property_img">
            <div class="property_text">
                <h3>Park Avenue Residence</h3>
                <p class="location">Midtown East</p>
                <p class="price">$6,800,000</p>
                <p class="details">4 Bed • 4 Bath • 3500 sqft</p>
            </div>
        </div>

        <div class="property" onclick="location.href='#home'">
            <img src="images/properties/tribeca_townhouse.png" class="property_img">
            <div class="property_text">
                <h3>Tribeca Townhouse</h3>
                <p class="location">Tribeca</p>
                <p class="price">$9,500,000</p>
                <p class="details">5 Bed • 6 Bath • 5200 sqft</p>
            </div>
        </div>

        <div class="property" onclick="location.href='#home'">
            <img src="images/properties/fifth_avenue.png" class="property_img">
            <div class="property_text">
                <h3>Fifth Avenue Apartment</h3>
                <p class="location">Central Park South, NYC</p>
    ...
    <section class="why_choose_us">
        ...
        <div class="reasons_grid">
            <div class="reason">
                ...
                <p>
                    We specialize in the most exclusive homes and residences in New York City, offering elegance, sophistication, and modern living.
                </p>
            </div>
            <div class="reason">
                <h3>Expert Agents</h3>
                <p>Our experienced real estate professionals provide personalized guidance and exceptional service tailored to your unique needs.</p>
            </div>
            <div class="reason">
                <h3>Unmatched Locations</h3>
                <p>From Upper East Side penthouses to SoHo lofts, we connect you with properties in the most desirable neighborhoods in Manhattan.</p>
            </div>
        </div>
    </section>    
</body>
