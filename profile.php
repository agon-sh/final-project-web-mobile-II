...
<meta charset="UTF-8">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        header { display: flex; align-items: center; position: fixed; top: 0; left: 0; width: 100%; height: 60px; background: black; z-index: 10; }
        .logo { height: 40px; margin-left: 20px; }
        .company-name { font-size: 24px; color: #fff; font-weight: bold; margin-left: 10px; }
        a { color: #0a033a; text-decoration: none; }
        .container { background: #fff; border: 1px solid #ccc; max-width: 800px; margin: 20px auto; padding: 16px; }
        h2, h3 { color: #0a033a; margin-bottom: 8px; }
        p, td, th { font-size: 14px; }
        table { width: 100%; border-collapse: collapse; background: #fff; }
        th, td { border: 1px solid #ccc; padding: 8px; }
        th { background: #eee; }
        form { background: #fff; border: 1px solid #ccc; padding: 16px; margin-bottom: 20px; }
        form p { margin-bottom: 8px; }
        form input[type=text], form input[type=number], form textarea { width: 100%; padding: 6px; border: 1px solid #ccc; }
        form input[type=submit] { padding: 6px 12px; background: #0a033a; color: #fff; border: none; cursor: pointer; }
    </style>
</head>
<body>
